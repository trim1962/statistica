...
\end{figure}
La frequenza percentuale  è una riscrittura della percentuale.
\begin{defn}[Frequenza percentuale]\index{Frequenza!percentuale}
	La frequenza relativa espressa in forma percentuale.
\end{defn} 
...
\begin{defn}[Frequenza cumulata]\index{Frequenza!cumulata!assoluta}
...
\begin{defn}[Frequenza relativa cumulata]\index{Frequenza!cumulata!relativa}
...
\begin{defn}[Frequenza retrocumulata]\index{Frequenza!retrocumulata!assoluta}
...
\begin{defn}[Frequenza relativa retrocumulata]\index{Frequenza!cumulata!relativa}
...
\end{defn}
 \section{Incrementi }
 Per incremento\index{Incremento} si intende la variazione di una quantità confrontata con un altro valore.
 \begin{defn}[Incremento]
 	Dati due dati, uno iniziale $x_i$ e l'altro finale $x_f$ definisco incremento il valore  \[\Delta I=x_f-x_i\]
 \end{defn}
 \begin{commento}{Confronti}
 	\begin{description}
 		\item[$\Delta I=x_f-x_i>0$] In questo caso abbiamo un incremento positivo, perché il valore finale è maggiore di quello iniziale;
 		\item[$\Delta I=x_f-x_i<0$] In questo caso abbiamo un incremento negativo, perché il valore finale è minore di quello  iniziale;
 		\item[$\Delta I=x_f-x_i=0$] In questo caso abbiamo un incremento nullo perché il valore finale è uguale a quello  iniziale;
 	\end{description}
 \end{commento}
Per confrontare gruppi di dati viversi si introduce l'incremento percentuale.
\begin{defn}[Incremento percentuale]
	Dati due dati, uno iniziale $x_i$ e l'altro finale $x_f$ definisco incremento percentuale il valore  \[\Delta I=\dfrac{x_f-x_i}{x_i}\cdot 100\]
\end{defn} 