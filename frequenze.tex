...
\end{defn}Guardando la tabella vediamo che la frequenza assoluta del voto ``cinque'' è due perché  nella tabella~\vref{tab:alunnovoto1} il voto ``cinque'' compare due volte. La tabella~\vref{tab:FrequenzeAssolute} rappresenta le frequenze assolute dei voti della verifica. 
